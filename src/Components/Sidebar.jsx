    ...
    function linkClasses(type = null) {
        ...
        if (type === subpages) {
            if(subpages === "ecommerce"){
                return classes += "bg-gradient-to-r from-gray-700 py-2.3 via-gray-500 w-[115%]   to-gray-300 overflow-hidden hover:text-white text-white  border-gray-500 hover:border-gray-500"
            }
            if(subpages === "blogapp"){
