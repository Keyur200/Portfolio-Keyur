  ...
  return (
    <div className=' h-auto overflow-hidden bg-white  p-5'>
      <Link target={'_blank'} to={'https://blogapp-gdn9.vercel.app'} className='relative mainn overflow-hidden cursor-pointer '>
        <img src="../images/banner1.png" className='border-4 hover:scale-125 border-black rounded-xl' alt="" />
        ...
        <p className="bg bg-gradient-to-tr from-blue-300  to-sky-200"><p className='flex gap-3 text-sm md:text-lg lg:text-xl  items-center hover:scale-125 transition-transform duration-500 font-bold'>Click to redirect website <FaExternalLinkAlt /></p>  </p>
      </Link>
